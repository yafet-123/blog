        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-16">
          ...
          <div className="footer-brand px-5 lg:px-[30px] py-[40px] bg-[#0E0C0B] bg-center bg-repeat" style={{ backgroundImage: "url('/footer-form-bg.png')" }}>
            ...
            <div className="flex flex-col justify-center items-center">
              <p className="text-[#dec08c] font-bold mb-2 text-center text-2xl lg:text-4xl">Blog</p>

              <a href="mailto:yafetaddisu123@gmail.com" className="text-center text-[#dec08c] font-semibold mb-2 hover:text-yellow-400">yafetaddisu123@gmail.com</a>
              ...
              <a href="tel:+251970338592" className="text-[#dec08c] mb-2 hover:text-yellow-400 font-semibold">+251970338592</a>
            </div>
