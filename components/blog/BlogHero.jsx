...
const Hero = ({
  ...
  return (
    ...
    >
      ...
      <div className="lg:px-5 pt-10">
        <h1 className="font-bold text-black text-left text-[40px] md:text-4xl lg:text-5xl mb-5">
          {title}
        </h1>
        <p className="text-black font-semibold text-left md:tracking-wider mb-5 text-md md:text-lg lg:text-xl">
          {description}
        </p>
      </div>
